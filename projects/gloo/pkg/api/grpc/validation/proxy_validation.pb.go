...
const (
	...
	ListenerReport_Error_PluginError            ListenerReport_Error_Type = 3
)
...
const (
	...
	VirtualHostReport_Error_PluginError           VirtualHostReport_Error_Type = 2
)
...
const (
	...
	RouteReport_Error_PluginError             RouteReport_Error_Type = 2
)
...
const (
	...
	TcpListenerReport_Error_PluginError            TcpListenerReport_Error_Type = 3
)
...
const (
	...
	TcpHostReport_Error_PluginError             TcpHostReport_Error_Type = 2
)
...
type HttpListenerReport struct {
	// errors that were detected on the top-level http listener plugins
...
func (m *HttpListenerReport) GetErrors() []string {
	if m != nil {
		return m.Errors
	}
	return nil
...
type TcpListenerReport struct {
	...
	// Types that are valid to be assigned to ListenerTypeReport:
	//	*TcpListenerReport_HttpListenerReport
	//	*TcpListenerReport_TcpListenerReport
	ListenerTypeReport   isTcpListenerReport_ListenerTypeReport `protobuf_oneof:"listener_type_report"`
	XXX_NoUnkeyedLiteral struct{}                               `json:"-"`
	XXX_unrecognized     []byte                                 `json:"-"`
	XXX_sizecache        int32                                  `json:"-"`
}
...
type isTcpListenerReport_ListenerTypeReport interface {
	isTcpListenerReport_ListenerTypeReport()
}
...
func (*TcpListenerReport_TcpListenerReport) isTcpListenerReport_ListenerTypeReport()  {}

func (m *TcpListenerReport) GetListenerTypeReport() isTcpListenerReport_ListenerTypeReport {
	if m != nil {
		return m.ListenerTypeReport
	}
	return nil
...
func (m *TcpListenerReport) GetHttpListenerReport() *HttpListenerReport {
	if x, ok := m.GetListenerTypeReport().(*TcpListenerReport_HttpListenerReport); ok {
		return x.HttpListenerReport
	}
	return nil
}

func (m *TcpListenerReport) GetTcpListenerReport() *TcpListenerReport {
	if x, ok := m.GetListenerTypeReport().(*TcpListenerReport_TcpListenerReport); ok {
		return x.TcpListenerReport
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*TcpListenerReport) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*TcpListenerReport_HttpListenerReport)(nil),
		(*TcpListenerReport_TcpListenerReport)(nil),
	}
}
...
var fileDescriptor_8f4537dae4069b18 = []byte{
	...
	,
}
