...
type GatewayOptions struct {
	...
	Validation           *GatewayOptions_ValidationOptions `protobuf:"bytes,1,opt,name=validation,proto3" json:"validation,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                          `json:"-"`
	XXX_unrecognized     []byte                            `json:"-"`
	XXX_sizecache        int32                             `json:"-"`
}
...
type GatewayOptions_ValidationOptions struct {
	...
	// Bind Port for the Kubernetes Validating webhook, served by the Gateway. Defaults to `443`
	ValidationWebhookBindPort uint32 `protobuf:"varint,3,opt,name=validation_webhook_bind_port,json=validationWebhookBindPort,proto3" json:"validation_webhook_bind_port,omitempty"`
	// Path to TLS Certificate for Kubernetes Validating webhook. Defaults to `/etc/gateway/validation-certs/tls.crt`
	ValidationWebhookTlsCert string `protobuf:"bytes,4,opt,name=validation_webhook_tls_cert,json=validationWebhookTlsCert,proto3" json:"validation_webhook_tls_cert,omitempty"`
	// Path to TLS Private Key for Kubernetes Validating webhook. Defaults to `/etc/gateway/validation-certs/tls.key`
	ValidationWebhookTlsKey string   `protobuf:"bytes,5,opt,name=validation_webhook_tls_key,json=validationWebhookTlsKey,proto3" json:"validation_webhook_tls_key,omitempty"`
	XXX_NoUnkeyedLiteral    struct{} `json:"-"`
	XXX_unrecognized        []byte   `json:"-"`
	XXX_sizecache           int32    `json:"-"`
}
...
func (m *GatewayOptions_ValidationOptions) GetValidationWebhookBindPort() uint32 {
	if m != nil {
		return m.ValidationWebhookBindPort
	}
	return 0
}
...
var fileDescriptor_bd7533c2495e1752 = []byte{
	...
	,
}
...
func (this *GatewayOptions_ValidationOptions) Equal(that interface{}) bool {
	...
	if this.ValidationWebhookBindPort != that1.ValidationWebhookBindPort {
		return false
	}
