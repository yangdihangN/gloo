...
type GlooOptions_InvalidConfigPolicy struct {
	// if True, routes whose destinations point to a service or upstream which does not exist
	// (or is not visible within Gloo's watchNamespaces) will respond to clients with a fallback
	// message
	// default is 'false'
	EnableFallbackResponse bool `protobuf:"varint,1,opt,name=enable_fallback_response,json=enableFallbackResponse,proto3" json:"enable_fallback_response,omitempty"`
	// if enableFallbackResponse is set to `true`, reply to clients with this response code
	// default is 404
	FallbackResponseCode int64 `protobuf:"varint,2,opt,name=fallback_response_code,json=fallbackResponseCode,proto3" json:"fallback_response_code,omitempty"`
	// if enableFallbackResponse is set to `true`, reply to clients with this body
	// default is 'Gateway has invalid configuration. Administrators should run `glooctl check` to find and fix config errors.'
	FallbackResponseBody string   `protobuf:"bytes,3,opt,name=fallback_response_body,json=fallbackResponseBody,proto3" json:"fallback_response_body,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GlooOptions_InvalidConfigPolicy) GetEnableFallbackResponse() bool {
	if m != nil {
		return m.EnableFallbackResponse
	}
	return false
}

func (m *GlooOptions_InvalidConfigPolicy) GetFallbackResponseCode() int64 {
	if m != nil {
		return m.FallbackResponseCode
	}
	return 0
}

func (m *GlooOptions_InvalidConfigPolicy) GetFallbackResponseBody() string {
	if m != nil {
		return m.FallbackResponseBody
	}
	return ""
}
...
var fileDescriptor_bd7533c2495e1752 = []byte{
	...
	,
}
...
func (this *GlooOptions_InvalidConfigPolicy) Equal(that interface{}) bool {
	...
	if this.EnableFallbackResponse != that1.EnableFallbackResponse {
		return false
	}
	if this.FallbackResponseCode != that1.FallbackResponseCode {
		return false
	}
	if this.FallbackResponseBody != that1.FallbackResponseBody {
		return false
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
		return false
