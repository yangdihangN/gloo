...
Gloo is uniquely designed to support hybrid applications, in which multiple technologies, architectures, protocols,
and clouds can coexist.

Community
---------
- Join us on our `Slack channel <https://slack.solo.io/>`_
- Follow us on `Twitter <https://twitter.com/soloio_inc>`_
