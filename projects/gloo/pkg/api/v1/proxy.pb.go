...
type Listener struct {
	...
	ListenerPlugins      *ListenerPlugins `protobuf:"bytes,8,opt,name=listener_plugins,json=listenerPlugins,proto3" json:"listener_plugins,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *Listener) GetListenerPlugins() *ListenerPlugins {
	if m != nil {
...
type TcpListener struct {
	...
	// Plugins contains top-level plugin configuration to be applied to a listener
	// Listener config is applied to all tcp traffic that connects to this listener.
	ListenerPlugins      *TcpListenerPlugins `protobuf:"bytes,2,opt,name=listener_plugins,json=listenerPlugins,proto3" json:"listener_plugins,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *TcpListener) GetListenerPlugins() *TcpListenerPlugins {
	if m != nil {
		return m.ListenerPlugins
	}
	return nil
...
var fileDescriptor_c6a47f72e9923590 = []byte{
	...
	,
}
