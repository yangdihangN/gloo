job "gloo" {
  ...
  group "gloo" {
    ...
    task "gloo" {
      ...
      driver = "docker"
      config {
        image = "gcr.io/solo-public/gloo:test-ilackarms"
        port_map {
          xds = 9977
        }
        args = [
        ...
        volumes = [
          "/Users/ilackarms/go/src/github.com/solo-io/gloo/nomad/data:/data/",
        ]
      }
      resources {
        cpu = 500
    ...
    task "gateway" {
      ...
      driver = "docker"
      config {
        image = "gcr.io/solo-public/gateway:test-ilackarms"
        args = [
          "--dir=/data/",
        ]
        volumes = [
    ...
    task "discovery" {
      ...
      driver = "docker"
      config {
        image = "gcr.io/solo-public/discovery:test-ilackarms"
        args = [
          "--dir=/data/",
        ]
        volumes = [
