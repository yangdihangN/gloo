...
<table>
  <tr height="100">
    <td width="10%">
      <a href="gateway"><img src={{% versioned_href fromRoot="/img/Gloo-01.png" %}} width="60"/></a>
    </td>
    <td>
  ...
  <tr height="100">
    <td width="10%">
      <a href="knative"><img src={{% versioned_href fromRoot="/img/knative.png" %}} width="60"/></a>
    </td>
    <td>
  ...
  <tr height="100">
    <td width="10%">
      <a href="ingress"><img src={{% versioned_href fromRoot="/img/ingress.png" %}} width="60"/></a>
    </td>
...
<table>
  <tr height="100">
    <td width="10%">
      <a href="enterprise"><img src={{% versioned_href fromRoot="/img/gloo-ee.png" %}} width="60"/></a>
    </td>
    <td>
