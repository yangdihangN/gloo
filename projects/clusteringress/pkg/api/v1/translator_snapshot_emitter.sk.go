...
var (
	...
	mTranslatorSnapshotIn     = stats.Int64("translator.clusteringress.gloo.solo.io/emitter/snap_in", "The number of snapshots in", "1")
	...
	mTranslatorSecretsListIn = stats.Int64(
		"translator.clusteringress.gloo.solo.io/emitter/secrets_in",
		"The number of Secret lists received on watch channel", "1")
	mTranslatorClusteringressesListIn = stats.Int64(
		"translator.clusteringress.gloo.solo.io/emitter/clusteringresses_in",
		"The number of ClusterIngress lists received on watch channel", "1")
	...
	translatorSecretsListInView = &view.View{
		Name:        "translator.clusteringress.gloo.solo.io/emitter/secrets_in",
	...
	translatorClusteringressesListInView = &view.View{
		Name:        "translator.clusteringress.gloo.solo.io/emitter/clusteringresses_in",
		Measure:     mTranslatorClusteringressesListIn,
		Description: "The number of ClusterIngress lists received on watch channel.",
		Aggregation: view.Count(),
		TagKeys: []tag.Key{
			translatorNamespaceKey,
		},
...
func init() {
	view.Register(
		...
		translatorClusteringressesListInView,
	)
}
		...
		for {
			...
			case clusterIngressNamespacedList := <-clusterIngressChan:
				...
				stats.RecordWithTags(
					ctx,
					[]tag.Mutator{tag.Insert(translatorNamespaceKey, namespace)},
					mTranslatorClusteringressesListIn.M(1),
				)
