...
import (
	...
	"github.com/solo-io/gloo/projects/gatewayinit/pkg/convertv2alpha1"
...
func main() {
	...
	converter := mustNewConverter(ctx)
	converter.Convert()
}

func mustNewConverter(ctx context.Context) convertv2alpha1.Converter {
	// Get shared cache
	...
	gatewayConverter := convertv2alpha1.NewGatewayConverter()

	return convertv2alpha1.NewConverter(ctx, v1GatewayClient, v2alpha1GatewayClient, gatewayConverter, "gloo-system")
}
